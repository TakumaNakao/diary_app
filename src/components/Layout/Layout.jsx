...
import { Calendar as CalendarIcon, Tag, Settings, ChevronRight, ChevronDown, Search as SearchIcon, Menu, X, Moon, Sun, FileText, Pin } from 'lucide-react';
        ...
        <div className="app-layout">
            ...
            <aside className={`sidebar ${isSidebarOpen ? 'open' : ''}`}>
                ...
                <nav className="sidebar-nav">
                    ...
                    <Link to="/pinned" className={`nav-item ${isActive('/pinned')}`}>
                        <Pin size={20} />
                        <span>Pinned</span>
                    </Link>
